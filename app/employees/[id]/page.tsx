    ...
    <div className="p-6 space-y-6 max-w-5xl">
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
        <div className="flex items-start gap-5">
          <div className="w-20 h-20 rounded-2xl bg-indigo-100 flex items-center justify-center text-3xl font-bold text-indigo-700 flex-shrink-0">
            {emp.avatar}
          </div>
          <div className="flex-1">
            <div className="flex flex-wrap items-center gap-3">
              <h1 className="text-2xl font-bold text-gray-900">{emp.name}</h1>
              <span className="text-sm text-gray-400">{emp.nameKana}</span>
              <span
          ...
          <div className="text-right flex-shrink-0">
            <div className="text-xs text-gray-400 mb-1">2024年度評価</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
          <h2 className="font-semibold text-gray-800 mb-4">スキル一覧</h2>
      ...
      {/* Projects */}
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
        <h2 className="font-semibold text-gray-800 mb-3">参加プロジェクト</h2>
        <div className="flex flex-wrap gap-2">
          {emp.projects.map((proj) => (
            <span
              key={proj}
              className="flex items-center gap-1.5 text-sm bg-indigo-50 text-indigo-700 px-3 py-1.5 rounded-lg"
            >
