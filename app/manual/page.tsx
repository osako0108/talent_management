...
const sections = [
  ...
  },
  {
    ...
    title: "全体設定",
    description:
      "システム全体で使用するマスタデータ（部署・役職・スキル・グレード・ステータス）をタブ切り替えで一元管理します。",
    features: [
      "部署マスタ（部署名・部署長・予算・カラー）",
      "役職マスタ（役職名・説明）",
      "スキルマスタ（カテゴリ・スキル・タグの管理）",
      "グレードマスタ（コード・名称・表示順）",
      "ステータスマスタ（コード・名称・カラー）",
    ],
  },
...
const stepGuides = [
  ...
  {
    title: "グレード・ステータス・役職を管理する",
    steps: [
      "サイドバーの「全体設定」をクリック",
      "管理したいマスタ（グレード・ステータス・役職）のタブを選択",
      "「新規追加」ボタンで項目を追加",
      "コード・名称などを入力して「保存」",
      "登録した内容は従業員管理やその他の画面で選択肢として利用される",
    ],
  },
  {
    title: "スキルギャップを分析する",
